...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Miesmuschel.st', 'src/Miesmuschel-Backend.st', // list all sources in dependency order
                    'src/Miesmuschel-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-miesmuschel',
